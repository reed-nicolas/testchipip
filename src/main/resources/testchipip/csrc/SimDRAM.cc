...
// memory timing model: 0 = magic (untimed), 2 = DRAMSim2, 3 = DRAMSim3
int dramsim_version = 0;
std::string dramsim_ini = "DRAMSim3.ini";                            // DRAMSim3 config file
std::string dramsim_out = "dramsim-results";                         // DRAMSim3 output dir
std::string dramsim2_memory_ini = "DDR3_micron_64M_8B_x4_sg15.ini";  // DRAMSim2 device ini
std::string dramsim2_system_ini = "system.ini";                     // DRAMSim2 system ini
std::string dramsim2_ini_dir = "dramsim2_ini";                      // DRAMSim2 ini directory
